                        ...
                        <table id="tablaPersonas" class="table table-striped table-bordered table-condensed" style="width:100%">
                            ...
                            foreach($data as $dat) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $dat['privilegios'] ?></td>
                ...
                <div class="modal-content">
                    ...
                    <form id="formPersonas">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="usuario" class="col-form-label">email:</label>
                            ...
                            <div class="form-group">
                                <label for="privilegios" class="col-form-label">Privilegios:</label>
                                <input type="text" class="form-control" id="privilegios">
                            </div>
                            <div class="form-group">
